...
description: >
  Drupal security expertise. Auto-activates when writing forms, controllers, queries, or handling user input.
  Prevents XSS, SQL injection, and access bypass vulnerabilities.
metadata:
  status: stable
...
// Drupal 10.2+ uses FileSecurity internally via file_validate_extensions
```
